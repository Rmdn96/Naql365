...
select public.intake_reject($q$select public.request_command('create',null,0,gen_random_uuid())$q$,'42501');
...
insert into intake_state values('draft',public.request_command('create',null,0,'d0000000-0000-4000-8000-000000000001'));
select public.intake_assert(public.request_command('create',null,0,'d0000000-0000-4000-8000-000000000001')=(select value from intake_state where key='draft'),'create retry one draft');
insert into intake_state values('payload',jsonb_build_object(
 ...
 'pickup',jsonb_build_object('city','Riyadh','district','Fixture','address','Fixture pickup','notes','','floor',2,'elevator',true,'access_notes',''),
 'delivery',jsonb_build_object('city','Jeddah','district','Fixture','address','Fixture delivery','notes','','floor',1,'elevator',false,'access_notes',''),
...
insert into intake_state values('draft_b',public.request_command('create',null,0,gen_random_uuid()));

...
revision?: number;
completed_at?: string | null;
}; Relationships: [{"foreignKeyName":"jobs_organization_id_fkey","columns":["organization_id"],"referencedRelation":"organizations","referencedColumns":["id"],"isOneToOne":false},{"foreignKeyName":"jobs_organization_id_order_id_fkey","columns":["organization_id","order_id"],"referencedRelation":"orders","referencedColumns":["organization_id","id"],"isOneToOne":true}] };
...
created_at?: string;
captured_at?: string | null;
}; Relationships: [{"foreignKeyName":"trip_pods_actor_id_fkey","columns":["actor_id"],"referencedRelation":"profiles","referencedColumns":["id"],"isOneToOne":false},{"foreignKeyName":"trip_pods_organization_id_trip_id_fkey","columns":["organization_id","trip_id"],"referencedRelation":"trips","referencedColumns":["organization_id","id"],"isOneToOne":true}] };
trip_stop_dependencies: { Row: {
organization_id: string;
trip_id: string;
...
delivery_stop_id?: string;
pickup_stop_id?: string;
}; Relationships: [{"foreignKeyName":"trip_stop_dependencies_organization_id_trip_id_delivery_st_fkey","columns":["organization_id","trip_id","delivery_stop_id"],"referencedRelation":"trip_stops","referencedColumns":["organization_id","trip_id","id"],"isOneToOne":false},{"foreignKeyName":"trip_stop_dependencies_organization_id_trip_id_pickup_stop_fkey","columns":["organization_id","trip_id","pickup_stop_id"],"referencedRelation":"trip_stops","referencedColumns":["organization_id","trip_id","id"],"isOneToOne":false}] };
trip_stops: { Row: {
id: string;
organization_id: string;
trip_id: string;
...
}; Views: { [_ in never]: never }; Functions: { calculate_preliminary_price: { Args: { p_request_id: string; p_distance_km: number; p_source_note: string; p_vehicle_class_id: string; p_worker_count: number; p_mutation_id: string }; Returns: Json };create_customer_request: { Args: { p_key: string }; Returns: Json };create_quote_draft: { Args: { p_evaluation_id: string; p_adjustment_minor: number; p_adjustment_reason: string; p_validity_seconds: number; p_mutation_id: string }; Returns: Json };customer_enrollment_state: { Args: { [_ in never]: never }; Returns: string };customer_order_progress: { Args: { p_order_id: string }; Returns: Json };has_permission: { Args: { organization_id: string; permission_code: string }; Returns: boolean };onboard_customer: { Args: { p_name: string; p_phone: string; p_locale: string }; Returns: string };operational_job_summary: { Args: { p_job_id: string }; Returns: Json };operations_command: { Args: { p_organization_id: string; p_action: string; p_entity_id: string; p_revision: number; p_mutation_id: string; p_payload?: Json }; Returns: Json };request_command: { Args: { p_operation: string; p_request_id: string; p_revision: number; p_mutation_id: string; p_payload?: Json }; Returns: Json };request_file_command: { Args: { p_operation: string; p_request_id: string; p_file_id: string; p_mime?: string; p_size?: number }; Returns: Json };respond_to_quote: { Args: { p_quote_version_id: string; p_action: string; p_idempotency_key: string; p_reason?: string }; Returns: Json };send_quote: { Args: { p_quote_version_id: string }; Returns: Json };trip_pod_command: { Args: { p_trip_id: string; p_file_id: string; p_action: string; p_recipient?: string; p_mime?: string; p_size?: number; p_notes?: string }; Returns: Json };view_customer_quote: { Args: { p_quote_version_id: string }; Returns: Json } }; Enums: { [_ in never]: never }; CompositeTypes: { [_ in never]: never } } };

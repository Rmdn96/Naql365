...
export async function foundationDatabase() {
  ...
  await db.exec(`
    ...
    create schema auth;
    create table auth.users(id uuid primary key, raw_user_meta_data jsonb default '{}'::jsonb, email text, email_confirmed_at timestamptz);
    ...
    -- Emulate the documented operation-aware helper; full Supabase CI uses its real implementation.
